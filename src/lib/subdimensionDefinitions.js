// src/lib/subdimensionDefinitions.js
// CareerDNA v2 — backend copy of subdimension definitions.
// Keyed by the exact label strings used in questions.js, archetypeWeights.js, and subdim_matrix.js.
...
const SUBDIMENSION_DEFINITIONS = {
  ...
  // WHAT MATTERS
  "Purpose & Impact":
    "Reflects motivation to contribute to something larger than personal success, and a need for meaning through helping others or society. Higher scores indicate that work without a broader positive impact is difficult to sustain.",
...
module.exports = SUBDIMENSION_DEFINITIONS;
